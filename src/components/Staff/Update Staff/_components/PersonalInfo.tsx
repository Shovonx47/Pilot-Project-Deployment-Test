...
const PersonalInfo = ({ control, setValue, trigger, singleStaff }: PersonalInfoProps) => {
            ...
            <div className="border rounded-md">
                ...
                <div className="ml-4">
                    <Controller
                        name="profileImage"
                        control={control}
                        defaultValue={singleStaff?.data?.profileImage || null} // Ensure a proper default value
                            ...
                            <div className="mt-1 flex items-center">
                                ...
                                <div className="ml-3">
                                    ...
                                    <button
                                        ...
                                        onClick={() => {
                                            setValue("profileImage", singleStaff?.data?.profileImage);
                ...
                <div className="m-4 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
                    ...
                    <Controller
                        name="userId"
                        control={control}
                        defaultValue={singleStaff?.data?.userId || ""}
                    ...
                    <Controller
                        name="category"
                        control={control}
                        defaultValue={singleStaff?.data?.category || ""}
                    ...
                    <Controller
                        name="joiningDate"
                        control={control}
                        defaultValue={singleStaff?.data?.joiningDate || ""}
                    ...
                    <Controller
                        name="gender"
                        control={control}
                        defaultValue={singleStaff?.data?.gender || ""}
                    ...
                    <Controller
                        name="dateOfBirth"
                        control={control}
                        defaultValue={singleStaff?.data?.dateOfBirth || ""}
                    ...
                    <Controller
                        name="bloodGroup"
                        control={control}
                        defaultValue={singleStaff?.data?.bloodGroup || ""}
                    ...
                    <Controller
                        name="maritalStatus"
                        control={control}
                        defaultValue={singleStaff?.data?.maritalStatus || ""}
                    ...
                    <Controller
                        name="religion"
                        control={control}
                        defaultValue={singleStaff?.data?.religion || ""}
                    ...
                    <Controller
                        name="contactNumber"
                        control={control}
                        defaultValue={singleStaff?.data?.contactNumber || ""}
                    ...
                    <Controller
                        ...
                        control={control}
                        defaultValue={singleStaff?.data?.alternativeContactNumber || ""}
                    ...
                    <Controller
                        name="nidNumber"
                        control={control}
                        defaultValue={singleStaff?.data?.nidNumber || ""}
                    ...
                    <Controller
                        ...
                        control={control}
                        defaultValue={singleStaff?.data?.educationalQualification || ""}
                    ...
                    <Controller
                        name="motherTongue"
                        control={control}
                        defaultValue={singleStaff?.data?.motherTongue || ""}
                    ...
                    <Controller
                        name="status"
                        control={control}
                        defaultValue={singleStaff?.data?.status || ""}
