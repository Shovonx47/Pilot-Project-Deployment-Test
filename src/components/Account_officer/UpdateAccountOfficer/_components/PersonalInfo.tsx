...
interface singleAccountOfficer {
    data: {
        profileImage: string;
        userId: string;
        firstName: string;
...
interface PersonalInfoProps {
    ...
    singleAccountOfficer: singleAccountOfficer
}

const PersonalInfo = ({ control, setValue, trigger, singleAccountOfficer }: PersonalInfoProps) => {



    return (
        <div className="p-6 bg-white">
            <h2 className="text-xl font-semibold text-gray-800">Update Accountant</h2>
            <nav className="text-sm text-gray-500 mb-4">
                Dashboard / Accountants / <span className="text-gray-800">Update Accountant</span>
            </nav>
            ...
            <div className="border rounded-md">
                ...
                <div className="ml-4">
                    <Controller
                        name="profileImage"
                        control={control}
                        defaultValue={singleAccountOfficer?.data?.profileImage || null} // Ensure a proper default value
                            ...
                            <div className="mt-1 flex items-center">
                                ...
                                <div className="ml-3">
                                    ...
                                    <button
                                        ...
                                        onClick={() => {
                                            setValue("profileImage", singleAccountOfficer?.data?.profileImage);
                ...
                <div className="m-4 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
                    ...
                    <Controller
                        name="userId"
                        control={control}
                        defaultValue={singleAccountOfficer?.data?.userId || ""}
                    ...
                    <Controller
                        name="firstName"
                        control={control}
                        defaultValue={singleAccountOfficer?.data?.firstName || ""}
                    ...
                    <Controller
                        name="lastName"
                        control={control}
                        defaultValue={singleAccountOfficer?.data?.lastName || ""}
                    ...
                    <Controller
                        name="category"
                        control={control}
                        defaultValue={singleAccountOfficer?.data?.category || ""}
                    ...
                    <Controller
                        name="joiningDate"
                        control={control}
                        defaultValue={singleAccountOfficer?.data?.joiningDate || ""}
                    ...
                    <Controller
                        name="gender"
                        control={control}
                        defaultValue={singleAccountOfficer?.data?.gender || ""}
                    ...
                    <Controller
                        name="dateOfBirth"
                        control={control}
                        defaultValue={singleAccountOfficer?.data?.dateOfBirth || ""}
                    ...
                    <Controller
                        name="bloodGroup"
                        control={control}
                        defaultValue={singleAccountOfficer?.data?.bloodGroup || ""}
                    ...
                    <Controller
                        name="maritalStatus"
                        control={control}
                        defaultValue={singleAccountOfficer?.data?.maritalStatus || ""}
                    ...
                    <Controller
                        name="religion"
                        control={control}
                        defaultValue={singleAccountOfficer?.data?.religion || ""}
                    ...
                    <Controller
                        name="contactNumber"
                        control={control}
                        defaultValue={singleAccountOfficer?.data?.contactNumber || ""}
                    ...
                    <Controller
                        ...
                        control={control}
                        defaultValue={singleAccountOfficer?.data?.alternativeContactNumber || ""}
                    ...
                    <Controller
                        name="email"
                        control={control}
                        defaultValue={singleAccountOfficer?.data?.email || ""}
                    ...
                    <Controller
                        name="nidNumber"
                        control={control}
                        defaultValue={singleAccountOfficer?.data?.nidNumber || ""}
                    ...
                    <Controller
                        ...
                        control={control}
                        defaultValue={singleAccountOfficer?.data?.educationalQualification || ""}
                    ...
                    <Controller
                        name="motherTongue"
                        control={control}
                        defaultValue={singleAccountOfficer?.data?.motherTongue || ""}
                    ...
                    <Controller
                        name="status"
                        control={control}
                        defaultValue={singleAccountOfficer?.data?.status || ""}
